...
# The mesh will be generated by the package `MeshMaker`.
import MeshMaker: T4block
...
import MeshCore: attribute
@show geom = attribute(conn.right, "geom")

# The coordinates of the vertices of the first tetrahedron can be done accessed as
